...
//	    return extractClamis(token, claims -> claims.getExpiration(), Date.class);
//	}
//
//	public <T> T extractClamis(String token, Function<Claims, T> claimsResolver, Class<T> type) {
//	    final Claims claims = extractAllClaims(token);
//	    return type.cast(claimsResolver.apply(claims));
//	}
